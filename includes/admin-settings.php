		...
		case "general":
			...
			if ( is_multisite() ) { 
				if( is_super_admin() ) {
					...
					$ms_show_all_settings = isset( $input['ms_show_all_settings'] ) ? sanitize_text_field( $input['ms_show_all_settings'] ) : $original_settings['ms_show_all_settings'];
					$original_settings['ms_show_all_points'] = $ms_show_all_settings;
